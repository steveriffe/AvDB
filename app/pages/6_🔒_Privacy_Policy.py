...
from app.utils.styling import apply_apple_style, render_portal_nav_link
...
with col1:
    ...
    st.markdown(
        ...
        <div style="background: rgba(17, 29, 51, 0.85); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 20px; line-height: 1.6; color: #CBD5E1; font-size: 0.92rem;">
            <p><b>1. Google OAuth Identity</b><br/>
            ...
            <p><b>2. Optional Saved Travel Records (BigQuery Cloud Vault)</b><br/>
...
with col2:
    ...
    st.markdown(
        """
        <div style="background: rgba(17, 29, 51, 0.85); border: 1px solid rgba(255, 255, 255, 0.08); border-radius: 14px; padding: 20px; line-height: 1.6; color: #CBD5E1; font-size: 0.92rem;">
            <p><b>1. No Third-Party Tracking or Ad Networks</b><br/>
            ...
            <p><b>2. No Monetization or Sharing of Travel Data</b><br/>
            ...
            <p><b>3. No Background Uploads Without Consent</b><br/>
